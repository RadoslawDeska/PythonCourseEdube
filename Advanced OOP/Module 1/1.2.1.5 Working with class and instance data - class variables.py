...
# d1 object variables were not influenced
print('contents of class variable accessed via d1:', d1.class_var)

# d2 object variables were not influenced
print('contents of class variable accessed via d2:', d2.class_var)

# class variable
print('contents of class variable accessed via Demo:', Demo.class_var)